...
import com.ellenmall.dao.*;
import com.ellenmall.pojo.*;
...
import com.ellenmall.vo.OrderItemVo;
import com.ellenmall.vo.OrderProductVo;
import com.ellenmall.vo.OrderVo;
import com.ellenmall.vo.ShippingItemVo;
...
public class IOrderServiceImpl {
     ...
     * @return
     */
    public ServerResponse createOrder(int userId, Integer shippingId){
    ...
    public ServerResponse orderList(int userId, int pageNum, int pageSize){
       return null;
    }

    public ServerResponse getOrderCartProduct(int userId, int orderId){
        return null;
    }

    public ServerResponse cancelOrder(int userId, int orderId) {
        return null;
    }

    public ServerResponse deleteOrder(int userId, int orderId){
        return null;
    }
    ...
    private ShippingItemVo getShippingVo(Shipping shipping){
        ShippingItemVo shippingVo = new ShippingItemVo();
    ...
    private void reducePrdouctStock(List<OrderItem> orderItems){
    ...
    private Order getOder(Integer userId, Integer shippingId, BigDecimal payment){
        Order order = new Order();
        long orderNo = this.generateOrderNo();
        order.setOrderNo(orderNo);
        order.setStatus(Constants.Order.STATUS_WAIT_PAY);
        order.setPostage(0);
        order.setPaymentType(Constants.Order.PAY_TYPE_ONLINE);
    ...
    private BigDecimal getOrderTotalPrice(List<OrderItem> orderItemList){
        ...
        for(OrderItem orderItem:orderItemList){
            payment = BigDecimalUtils.mul(payment.doubleValue(),orderItem.getTotalPrice().doubleValue());
        }
        return payment;
    }
    ...
    public ServerResponse<String> cancel(Integer userId, Long orderNo){
        ...
        if(order.getStatus() != Constants.Order.STATUS_WAIT_PAY){
            return ServerResponse.createByErrorMessage("已付款,无法取消订单");
        }
        Order updateOrder = new Order();
        updateOrder.setId(order.getId());
        updateOrder.setStatus(Constants.Order.STATUS_CANCELED);
    ...
    public ServerResponse<PageInfo> getOrderList(Integer userId, int pageNum, int pageSize){
        ...
        List<OrderVo> orderVoList = getOrderVoList(orderList,userId);
     ...
     * @return
     */
    private List<OrderVo> getOrderVoList(List<Order> orderList,Integer userId){
    ...
    public ServerResponse aliCallback(Map<String,String> params){
        ...
        if(order.getStatus() >= Constants.Order.STATUS_PAYED){
        ...
        if(Constants.AlipayCallback.TRADE_STATUS_TRADE_SUCCESS.equals(tradeStatus)){
            ...
            order.setStatus(Constants.Order.STATUS_PAYED);
